...
// marshalJSON is the function used to serialize response payloads.
// It is a package-level variable so tests can replace it to exercise error paths.
var marshalJSON = func(v any, prefix, indent string) ([]byte, error) {
