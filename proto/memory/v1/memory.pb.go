...
const file_memory_v1_memory_proto_rawDesc = "" +
	...
	"\x05links\x18\x02 \x03(\v2\x15.memory.v1.MemoryLinkR\x05links\"\xac\x01\n" +
	...
	"\trewritten\x18\x02 \x01(\bR\trewritten\x12'\n" +
	"\x0frewritten_query\x18\x03 \x01(\tR\x0erewrittenQuery\x12\x1a\n" +
	"\battempts\x18\x04 \x01(\x05R\battempts2\x8d\a\n" +
	"\rMemoryService\x12Y\n" +
	...
	"\n" +
	"GetRelated\x12\x1c.memory.v1.GetRelatedRequest\x1a\x1d.memory.v1.GetRelatedResponse\"%\x82\xd3\xe4\x93\x02\x1f\x12\x1d/memories/{memory_id}/relatedB2Z0github.com/j33pguy/magi/proto/memory/v1;memorypbb\x06proto3"
...
var file_memory_v1_memory_proto_goTypes = []any{
	...
	(*SearchConversationsRequest)(nil),  // 19: memory.v1.SearchConversationsRequest
	(*SearchConversationsResponse)(nil), // 20: memory.v1.SearchConversationsResponse
}
var file_memory_v1_memory_proto_depIdxs = []int32{
	...
	1,  // 6: memory.v1.SearchConversationsResponse.results:type_name -> memory.v1.MemoryResult
	2,  // 7: memory.v1.MemoryService.Remember:input_type -> memory.v1.RememberRequest
	4,  // 8: memory.v1.MemoryService.Recall:input_type -> memory.v1.RecallRequest
	6,  // 9: memory.v1.MemoryService.Forget:input_type -> memory.v1.ForgetRequest
	8,  // 10: memory.v1.MemoryService.List:input_type -> memory.v1.ListRequest
	10, // 11: memory.v1.MemoryService.Health:input_type -> memory.v1.HealthRequest
	12, // 12: memory.v1.MemoryService.CreateConversation:input_type -> memory.v1.CreateConversationRequest
	19, // 13: memory.v1.MemoryService.SearchConversations:input_type -> memory.v1.SearchConversationsRequest
	15, // 14: memory.v1.MemoryService.LinkMemories:input_type -> memory.v1.LinkMemoriesRequest
	17, // 15: memory.v1.MemoryService.GetRelated:input_type -> memory.v1.GetRelatedRequest
	3,  // 16: memory.v1.MemoryService.Remember:output_type -> memory.v1.RememberResponse
	5,  // 17: memory.v1.MemoryService.Recall:output_type -> memory.v1.RecallResponse
	7,  // 18: memory.v1.MemoryService.Forget:output_type -> memory.v1.ForgetResponse
	9,  // 19: memory.v1.MemoryService.List:output_type -> memory.v1.ListResponse
	11, // 20: memory.v1.MemoryService.Health:output_type -> memory.v1.HealthResponse
	13, // 21: memory.v1.MemoryService.CreateConversation:output_type -> memory.v1.CreateConversationResponse
	20, // 22: memory.v1.MemoryService.SearchConversations:output_type -> memory.v1.SearchConversationsResponse
	16, // 23: memory.v1.MemoryService.LinkMemories:output_type -> memory.v1.LinkMemoriesResponse
	18, // 24: memory.v1.MemoryService.GetRelated:output_type -> memory.v1.GetRelatedResponse
